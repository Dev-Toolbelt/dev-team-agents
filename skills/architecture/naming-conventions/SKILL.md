...
description: Naming and file structure conventions for frontend projects. Use when creating components, hooks, services, or organizing folders. Framework-agnostic rules with per-framework notes.
---
