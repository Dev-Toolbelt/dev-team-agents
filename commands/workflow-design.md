Load and follow the workflow defined in `.claude/dev-team-agents/workflows/design.md`.
...
**Note:** This command drives the full structured design workflow. For a quick, single-agent design task use `/devteam:design` instead.
