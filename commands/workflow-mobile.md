Load and follow the workflow defined in `.claude/dev-team-agents/workflows/mobile.md`.
...
**Note:** This command drives the full structured mobile workflow. For a quick, single-agent mobile task use `/devteam:mobile` instead.

Mobile scope: $ARGUMENTS
