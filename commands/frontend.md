...
```json
{
  "questions": [{
    ...
    "header": "Findings",
    "options": [
      { "label": "Resolver Code Review findings", "description": "Re-spawn frontend-developer para corrigir os apontamentos de código." },
      { "label": "Resolver QA findings", "description": "Re-spawn frontend-test-specialist para ajustar os testes." },
