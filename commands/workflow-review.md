Load and follow the workflow defined in `.claude/dev-team-agents/workflows/review.md`.
...
**Note:** This command drives the full structured review workflow. For a quick, single-pass review use `/devteam:review` instead.
