...
- `flow-no-pre-spawn-current-context-warm-cache` — 23 commands carregam current-context antes do spawn; cada agent re-executa `git diff main..HEAD` (~5-10s × agents); falta cache curto em `.claude/.context-cache.json` — [relatório](2026-05-12/02-fluxos-e-workflows.md)
