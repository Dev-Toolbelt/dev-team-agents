...
The `product-analyst` saves questions to `.claude/docs/backlog/client-clarifications.md`.
...
**The `client-clarifications.md` file is a project artifact** — it records the full Q&A history.
